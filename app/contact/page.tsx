        ...
        <section className="bg-gradient-to-r from-red-50 to-orange-50 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Have questions about our services? We're here to help you find your perfect property.
            </p>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  answer: "Simply sign up for an account and use our property listing wizard to add your property details, photos, and pricing information."
                },
                {
                  question: "Is there a fee for listing properties?",
                  answer: "Basic property listing is free. We offer premium packages with additional features for enhanced visibility."
                },
                {
                  question: "How do I contact interested buyers?",
                  answer: "You'll receive leads directly in your dashboard with contact information of interested buyers."
                },
                {
                  question: "Can I edit my property listing?",
                  answer: "Yes, you can edit your property details, photos, and pricing anytime from your dashboard."
                }
              ].map((faq, index) => (
                <Card key={index}>
