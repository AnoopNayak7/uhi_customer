            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                <div className="relative h-[500px] rounded-2xl overflow-hidden group mb-6">
                  <Image
                    src={images[currentImageIndex] || 'https://images.unsplash.com/photo-1613977257592-4871e5fcd7c4?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'}
                    alt={property.title}
                    fill
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {(property.features || ['Parking', 'Security', 'Gym', 'Garden', 'Swimming Pool', 'Clubhouse']).map((feature: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | PromiseLikeOfReactNode | null | undefined, index: Key | null | undefined) => (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center py-3 border-b border-gray-100">
                      ...
                      <span className="font-medium text-gray-900">{property.constructionStatus || 'Ready to Move'}</span>
                    </div>
                    <div className="flex justify-between items-center py-3 border-b border-gray-100">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center py-3 border-b border-gray-100">
                      ...
                      <span className="font-medium text-gray-900">{property.area} {property.areaUnit}</span>
                    </div>
                    <div className="flex justify-between items-center py-3 border-b border-gray-100">
                      <span className="text-gray-600">Possession:</span>
                      <span className="font-medium text-gray-900">{property.possessionDate || 'Immediate'}</span>
                    </div>
                    <div className="flex justify-between items-center py-3 border-b border-gray-100">
                ...
                <CardContent className="p-7">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <div className="text-base font-bold text-gray-900">Property Agent</div>
                        <div className="text-gray-600 text-sm">UrbanHouseIN</div>
