                  ...
                  <div className="relative">
                    <div className="relative h-48 overflow-hidden rounded-t-lg">
                      <PropertyListImage
                        src={
                          property.images?.[0] ||
                          "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=400&h=300&fit=crop&crop=center&auto=format&q=85"
                        }
                        alt={property.title}
                        fill
                        className="object-cover group-hover:scale-105 transition-transform duration-300"
                        blurDataURL={BLUR_DATA_URLS.property}
                        fallbackSrc="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=400&h=300&fit=crop&crop=center&auto=format&q=85"
                        index={0}
                      />
                    </div>
                    ...
                    <div className="absolute top-3 right-3">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem asChild>
                            <Link
                              href={`/dashboard/property/edit/${property.id}`}
                            >
