...
export default function InvestmentCalculatorPage() {
  ...
  const calculateROI = useCallback(() => {
    ...
    const futureValue =
      currentValue * Math.pow(1 + appreciationRate[0] / 100, years);
    ...
    const totalReturns =
      capitalGains + totalRentalIncome - taxOnRental - taxOnCapitalGains;
    ...
    const breakdown = [
      {
        ...
        value: Math.round(capitalGains),
        color: "#3b82f6",
      },
      {
        name: "Rental Income",
        value: Math.round(totalRentalIncome),
        color: "#10b981",
      },
      {
        name: "Taxes",
        value: Math.round(taxOnRental + taxOnCapitalGains),
        color: "#ef4444",
      },
      {
        name: "Maintenance",
        value: Math.round(annualMaintenance * years),
        color: "#f59e0b",
      },
    ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Calculate returns, rental yields, and investment projections for
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="space-y-3">
                            <div className="flex justify-between">
                              ...
                              <span className="font-medium">
                                {formatPrice(results.initialInvestment)}
                              </span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-gray-600">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span className="font-medium">
                                {formatPrice(results.futureValue)}
                              </span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-gray-600">
                              ...
                              <span className="font-medium text-green-600">
                                {formatPrice(results.capitalGains)}
                              </span>
                            </div>
                          </div>
                          <div className="space-y-3">
                            <div className="flex justify-between">
                              ...
                              <span className="font-medium">
                                {formatPrice(results.totalRentalIncome)}
                              </span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-gray-600">
                              ...
                              <span className="font-medium">
                                {formatPrice(results.netRentalIncome)}
                              </span>
                            </div>
                            <div className="flex justify-between">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <ul className="text-sm text-gray-600 space-y-1">
                              <li>
                                • Rental yield: {rentalYield[0]}% annually
                              </li>
                              <li>
                                • Capital appreciation: {appreciationRate[0]}%
                                per year
                              </li>
                              <li>
                                • Break-even: {results.paybackPeriod} years
                              </li>
                              <li>
                                • Total returns: {results.totalROI}% over{" "}
                                {investmentPeriod[0]} years
                              </li>
                            </ul>
                          </div>
                          <div>
                            ...
                            <div className="text-sm text-gray-600 space-y-1">
                              <div>
                                ROI Grade:{" "}
                                {parseFloat(results.annualizedROI) > 12
                                  ? "Excellent"
                                  : parseFloat(results.annualizedROI) > 8
                                  ? "Good"
                                  : "Average"}
                              </div>
                              <div>
                                Risk Level:{" "}
                                {rentalYield[0] > 7 ? "Low" : "Medium"}
                              </div>
