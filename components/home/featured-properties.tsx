  ...
  if (loading) {
    return (
      <HomeSection className="bg-[#FAFAFA]">
        <HomeSectionHeader
          title={`Featured properties in ${getLocationDisplay()}`}
          subtitle="Loading featured properties..."
        />
    ...
    return (
      <HomeSection className="bg-[#FAFAFA]">
        <div className="text-center">
          <HomeSectionHeader
            title={`Featured properties in ${getLocationDisplay()}`}
            subtitle="No featured properties available at the moment."
          />
  ...
  return (
    <HomeSection className="bg-[#FAFAFA]">
      <HomeSectionHeader
        ...
        title={`Featured properties in ${getLocationDisplay()}`}
        subtitle="Handpicked premium properties for discerning buyers"
        action={
          <HomeCarouselControls
            onPrev={() =>
